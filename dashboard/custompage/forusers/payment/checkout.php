...
class Payment
{
    ...
    public function checkout()
    {
        ...
        $post_data['success_url'] = "http://localhost/shop/dashboard/custompage/forusers/payment/success.php?quantity=".$_GET["quantity"]."&productname=".$_GET["productname"]."&modelname=".$_GET["modelname"]."&date=".$_GET["date"];
